...
import {
  inputComponents, selectComponents, layoutComponents, /* cloneInput, */ tableColumnItem, tableFormInput, tableFormSelect
...
export default {
  ...
  props: ['showField', 'activeData', 'formConf', 'createIdAndKey'],
  data() {
    return {
      currentTab: 'field',
      currentNode: null,
